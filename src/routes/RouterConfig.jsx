...
import Categorias from '../component/pages/Categorias';     // (Lo creamos)
import Ofertas from '../component/pages/Ofertas';         // (Lo creamos)
import Blog from '../component/pages/Blog';               // (Lo creamos)
import Contacto from '../component/pages/Contacto';         // (Lo creamos)
import Nosotros from '../component/pages/Nosotros';       // (Lo creamos)
...
const RouterConfig = () => {
  return (
    <BrowserRouter>
      {/* Nota: El Header y Footer ya no van aquí. 
        Deben ir dentro de cada página (o en un layout público)
        para que no aparezcan en el AdminLayout.
      */}
      <Routes>
        ...
        <Route path="/perfil" element={<PerfilCliente />} /> {/* TODO: Proteger esta ruta también */}
        ...
        <Route element={<AdminRoute />}>
          <Route path="/admin" element={<AdminLayout />}>
            ...
            {/* Rutas restantes */}
            {/* Rutas de Órdenes (¡AQUÍ ESTÁ EL PASO 4!) */}
...
// Asegúrate de que el nombre de exportación sea 'RouterConfig'
